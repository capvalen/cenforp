				...
				if ($respuesta) {
					...
					if ($respuesta["usuario"] == $_POST["ingUsuario"] && $respuesta["password"] == $encriptar) {
						...
						if ($respuesta["estado"] == 1) {
							...
							$_SESSION["idOcupacion"] = $respuesta["idOcupacion"];
							$_SESSION["opcionOcupacional"] = $respuesta["opcionOcupacional"];
	...
	static public function ctrCrearUsuario()
	{
		...
		if (isset($_POST["nuevoUsuario"])) {
			...
			if (preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevoNombre"]) && preg_match('/^[a-zA-Z0-9]+$/', $_POST["nuevoUsuario"]) && preg_match('/^[a-zA-Z0-9]+$/', $_POST["nuevoPassword"])) {
				...
				if (isset($_FILES['nuevaFoto']['tmp_name']) && isset($_POST['nuevaFoto'])) {
