        ...
        <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
          ...
          <tbody>
            ...
            foreach ($usuarios as $key => $value) {
              ...
              echo '<td>' . $value["opcionOcupacional"] . '</td>
                  <td>
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="file" name="nuevaFoto" class="nuevaFoto" accept="image/png,image/jpeg">
              <p class="help-block">Peso máximo de la foto 200 MB</p>
              <img src="vistas/img/usuarios/default/anonymous.png" alt="foto-defualt" style="max-width: 100px;">
            </div>
