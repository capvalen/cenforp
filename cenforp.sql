...
-- Tiempo de generación: 31-07-2023 a las 00:15:31
...
CREATE TABLE `alumnos` (
  ...
  `idNacionalidad` int NOT NULL DEFAULT '1',
  `idioma` varchar(50) DEFAULT NULL,
  `correo` varchar(100) DEFAULT NULL,
  `institucion` varchar(100) DEFAULT NULL,
  `calle` varchar(100) DEFAULT NULL,
  `numero` varchar(20) DEFAULT NULL,
  `distrito` varchar(6) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `provincia` varchar(4) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `departamento` varchar(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  ...
  `domicilioApoderado` text,
  `firma` varchar(30) DEFAULT NULL,
  `asistencia` int DEFAULT '0',
  `mes` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
INSERT INTO `alumnos` (`id`, `codigo`, `idOcupacion`, `condicion`, `turno`, `observaciones`, `nombre`, `apellidos`, `dni`, `ocupacion`, `fechaNacimiento`, `lugarNacimiento`, `idNacionalidad`, `idioma`, `correo`, `institucion`, `calle`, `numero`, `distrito`, `provincia`, `departamento`, `telefono`, `nombreApoderado`, `ocupacionApoderado`, `grado`, `estadoCivil`, `nacionalidadApoderado`, `domicilioApoderado`, `firma`, `asistencia`, `mes`, `registro`, `voucher`) VALUES
(12, 'CI00012023', 2, 'Becado', 'Mañanas', 'NINGUNA', 'MONICA ROBLES LOPEZ', '', '74562318', 'COMPUTACIÓN E INFORMATICA', '1990-03-06', 'HUANCAYO', 1, 'Español', 'MONICA@GMAIL.COM', 'MARISCAL CASTILLA', 'AV. HUANCAVELICA Nº120', '3', '020102', '0201', '02', '926444555', 'MONICA ROBLES PEREZ', 'Ama De Casa', 'Secundaria', 'Conviviente', 'Peruana', 'AV. HUANCAVELICA Nº120', 'NINGUNA', 11, 'Marzo', '2023-07-24 20:02:37', ''),
(13, 'CI00022023', 2, 'Becado', 'Mañana', 'NINGUNA', 'SLASH JORGE FLORES', '', '20365847', 'COMPUTACIÓN E INFORMATICA', '2000-10-25', 'HUANCAYO', 1, 'Español', 'SLASH@GMAIL.COM', 'MARISCAL CASTILLA', 'AV. HUANCAVELICA Nº125', '3', '020102', '0201', '02', '958152637', 'FERMIN ROBLES FLORES', 'Trabajador Independiente', 'Superior Tecnico', 'Casado', 'Peruana', 'AV. HUANCAVELICA Nº120', 'NINGUNA', 6, 'Enero', '2023-07-24 20:02:37', ''),
(14, 'MA00032023', 1, 'Becado', 'Mañana', 'NINGUNA', 'Doris Teresa Gaspar Tovar', '', '87451236', 'ELECTRICIDAD INDUSTRIAL', '2000-02-05', 'HUANCAYO', 1, 'Español', 'MONICA@GMAIL.COM', 'MARISCAL CASTILLA', 'AV. HUANCAVELICA Nº120', '3', '020102', '0201', '02', '987456123', 'MONICA ROBLES PEREZ', 'Ama De Casa', 'Primaria', 'Soltero', 'Peruana', 'AV. HUANCAVELICA Nº120', 'NINGUNA', 0, NULL, '2023-07-24 20:02:37', ''),
(15, 'CI00062023', 2, 'Becado', 'Mañana', 'NINGUNA', 'Silvia Espejo Leon', '', '12345678', 'COMPUTACIÓN E INFORMATICA', '2000-05-16', 'HUANCAYO', 1, 'Español', 'MONICA@GMAIL.COM', 'MARISCAL CASTILLA', 'AV. HUANCAVELICA Nº120', '3', '020102', '0201', '02', '965874123', 'MONICA ROBLES PEREZ', 'Soltero', 'Secundaria', 'Casado', 'Venezolano', 'AV. HUANCAVELICA Nº120', 'NINGUNA', 4, 'Enero', '2023-07-24 20:02:37', ''),
(16, 'CI00072023', 3, 'Regular', 'Mañana', '-', 'Carlos Alex Pariona Valencia', '', '44475064', 'SOLDADURA Y CONSTRUCCIONES MET', '1987-06-12', 'Huancayo', 1, 'Español', 'infocat2.0@gmail.com', 'Salesiano', 'Av. Hvca 435 El Tambo', '415', '020102', '0201', '02', '977692108', 'Alejandro Pariona', 'Desempleado', 'Superior Universitario', 'Divorciado', 'Peruana', 'Av. Huancavelica 435 El Tambo', '-', 0, NULL, '2023-07-24 20:02:37', ''),
(17, '5105050', 1, 'Becado', 'Tarde', '', 'Denis Gaspar Sedano', '', '25256235', 'ELECTRICIDAD INDUSTRIAL', '2025-02-05', 'Huancayo', 1, 'Español', 'infocat2.0@gmail.com', 'Salesiano', 'Av. Hvca 435 El Tambo', '415', '020102', '0201', '02', '999999999', 'Carlos Alex Pariona Valencia', 'Ama De Casa', 'Secundaria', 'Casado', 'Venezolano', 'Av. Huancavelica 435 El Tambo', 'Infocat Soluciones SAC', 0, NULL, '2023-07-24 20:02:37', ''),
(19, '2', 1, 'Becado', 'Mañana', 'dd', 'Carlos Alex Pariona Valencia', '', '15555555', 'ELECTRICIDAD INDUSTRIAL', '2055-11-05', 'Huancayo', 1, 'Español', 'infocat2.0@gmail.com', 'Salesiano', 'Av. Hvca 435 El Tambo', '415', '020102', '0201', '02', '550000000', 'Carlos Alex Pariona Valencia', 'Ama De Casa', 'Primaria', 'Soltero', 'Venezolano', 'Av. Huancavelica 435 El Tambo', 'Infocat Soluciones SAC', 0, NULL, '2023-07-24 20:02:37', ''),
(20, '2', 1, 'Becado', 'Mañana', 'dd', 'Carlos Alex Pariona Valencia', '', '15555555', 'ELECTRICIDAD INDUSTRIAL', '2055-11-05', 'Huancayo', 1, 'Español', 'infocat2.0@gmail.com', 'Salesiano', 'Av. Hvca 435 El Tambo', '415', '020102', '0201', '02', '550000000', 'Carlos Alex Pariona Valencia', 'Ama De Casa', 'Primaria', 'Soltero', 'Venezolano', 'Av. Huancavelica 435 El Tambo', 'Infocat Soluciones SAC', 0, NULL, '2023-07-24 20:02:37', ''),
(21, '2', 1, 'Becado', 'Mañana', 'dd', 'Carlos Alex Pariona Valencia', '', '15555555', 'ELECTRICIDAD INDUSTRIAL', '2055-11-05', 'Huancayo', 1, 'Español', 'infocat2.0@gmail.com', 'Salesiano', 'Av. Hvca 435 El Tambo', '415', '020102', '0201', '02', '550000000', 'Carlos Alex Pariona Valencia', 'Ama De Casa', 'Primaria', 'Soltero', 'Venezolano', 'Av. Huancavelica 435 El Tambo', 'Infocat Soluciones SAC', 0, NULL, '2023-07-24 20:02:37', ''),
(22, '3', 1, 'Becado', 'Tarde', '', 'Carlos Alex Pariona Valencia', '', '24444444', 'ELECTRICIDAD INDUSTRIAL', '2025-05-05', 'Huancayo', 1, 'Español', 'infocat2.0@gmail.com', 'Salesiano', 'Av. Hvca 435 El Tambo', '435', '020102', '0201', '02', '222222222', 'Carlos Alex Pariona Valencia', 'Trabajador Dependiente', 'Primaria', 'Soltero', 'Peruana', 'Av. Huancavelica 435 El Tambo', 'Infocat Soluciones SAC', 0, NULL, '2023-07-24 20:02:37', ''),
(23, '3', 1, 'Becado', 'Tarde', '', 'Carlos Alex Pariona Valencia', '', '24444444', 'ELECTRICIDAD INDUSTRIAL', '2025-05-05', 'Huancayo', 1, 'Español', 'infocat2.0@gmail.com', 'Salesiano', 'Av. Hvca 435 El Tambo', '435', '020102', '0201', '02', '222222222', 'Carlos Alex Pariona Valencia', 'Trabajador Dependiente', 'Primaria', 'Soltero', 'Peruana', 'Av. Huancavelica 435 El Tambo', 'Infocat Soluciones SAC', 0, NULL, '2023-07-24 20:02:37', ''),
(25, '3', 1, 'Becado', 'Mañana', '', 'Rosales Juana', '', '15555555', 'ELECTRICIDAD INDUSTRIAL', '2002-05-05', 'Huancayo', 1, 'Español', 'infocat.servicios@gmail.com', 'Salesiano', 'Av. Huancavelica', '435', '020102', '0201', '02', '255555555', 'Alejandro Pariona', 'Trabajador Dependiente', 'Primaria', 'Soltero', 'Peruana', 'Av. Huancavelica 435', '-', 0, NULL, '2023-07-24 20:02:37', ''),
(26, '52', 1, 'Becado', 'Mañana', '', 'a', '', '22222222', 'ELECTRICIDAD INDUSTRIAL', '2024-04-04', 's', 1, 'Español', 'sd', 'dsa', 'dsa', 'das', '020102', '0201', '02', '225555555', 'das', 'Trabajador Dependiente', 'Primaria', 'Soltero', 'Peruana', '421', '', 0, NULL, '2023-07-24 20:02:37', ''),
(28, 'CE0032023', 1, 'Becado', 'Mañana', '', 'Lopez Castro Jesus', '', '26600000', 'ELECTRICIDAD INDUSTRIAL', '2010-02-05', 'Av. Huancaliva 435', 1, 'Español', 'correo@gmail.com', 'salesiano', 'av. huancavelica', '145', '020102', '0201', '02', '960000000', 'lopez gomez daniel', 'Ama De Casa', 'Primaria', 'Soltero', 'Peruana', 'jr la merced 242 huancayo', '', 0, NULL, '2023-07-24 20:24:35', ''),
(29, '2', 8, 'Becado', 'Mañana', 'D', 'D', '', '22222222', '8', '2022-02-22', 'D', 1, 'Español', 'D', 'D', 'D', 'D', '020102', '0201', '02', '222222222', 'DD', 'Ama De Casa', 'Superior Tecnico', 'Divorciado', 'Peruana', 'D', '', 0, NULL, '2023-07-25 13:31:58', ''),
(30, '111', 5, 'Becado', 'Mañana', '', 'camilo', '', '55000000', '5', '2025-05-05', 'huancayo', 1, 'Español', '', '', 'av proceres', '252', '020102', '0201', '02', '500000044', '', '', '', '', '', '', '', 0, NULL, '2023-07-25 15:18:32', ''),
(31, '42', 2, 'Becado', 'Mañanas', '', 'perro 3', '', '55000000', '2', '2050-08-08', '2', 2, 'Español', '2', '2', '2', '2', '081007', '0810', '08', '532333111', 's', 'Trabajador Dependiente', 'Primaria', 'Divorciado', 'Peruana', 'dg', '', 5, NULL, '2023-07-25 15:36:47', ''),
(32, '2588', 2, 'Becado', 'Mañana', 'dd', 'daniel oscanoa velarde', '', '52222222', '2', '2024-04-04', 'fds', 1, 'Español', 'fds', 'fsd', 'fds', 'fds', '131007', '1310', '13', '333333333', 'fds', 'Ama De Casa', 'Secundaria', 'Soltero', 'Peruana', '3fffff', '', 3, NULL, '2023-07-25 20:24:33', ''),
(33, '25', 2, 'Regular', 'Noche', '', 'brunela', 'cardenas', '50805555', '2', '2011-11-11', 'das', 2, 'Español', 'dsa', 'das', 'das', 'das', '021208', '0212', '02', '225555555', 'das', 'Trabajador Dependiente', 'Secundaria', 'Casado', 'Peruana', 'dsa', '', 7, NULL, '2023-07-26 19:22:49', ''),
(34, 'CR250000', 2, 'Regular', 'Tarde', 'das', 'Britany', 'Jimenez', '24412222', '2', '2012-02-22', 'dsa', 1, 'Español', 'das', '', 'dsa', 'dsa', '160705', '1607', '16', '255555555', 'das', 'Ama De Casa', 'Secundaria', 'Casado', 'Venezolano', 'dd', '', 2, NULL, '2023-07-26 19:31:29', ''),
(35, 'SO0612023', 3, 'BECADO', 'MAñANA', '', 'YURI', 'AGUILAR', '50858888', '3', '2022-02-22', 'JAUJA', 2, 'ESPAñOL', 'MILUSUARIOS@GMAIL.COM', 'SALESIANO', 'AV DEUSTUA', '145', '040706', '0407', '04', '508888882', 'SALVATIERREZ SANTOS DANIEL', 'TRABAJADOR DEPENDIENTE', 'SECUNDARIA', 'SOLTERO', 'VENEZOLANO', 'AV. CAMANA 255', '', 0, NULL, '2023-07-26 20:04:53', ''),
(36, 'CR252023', 2, 'BECADO', 'MAñANA', '', 'DANIEL', 'SUASNABAR', '51188000', '2', '2010-05-05', 'HYO', 2, 'ESPAñOL', 'MMF@MFM.COM', 'SALESIANO', 'AV JUNIN', '25', '020201', '0202', '02', '258888883', 'CESAR DANTE', 'TRABAJADOR DEPENDIENTE', 'PRIMARIA', 'DIVORCIADO', 'OTRA', 'DOMINGO', '', 4, NULL, '2023-07-27 12:14:02', '64c2a360963d5.jpg'),
(37, '4222', 1, 'BECADO', 'MAñANA', '', 'PARIONA', 'CARLOS', '3566666_', '1', '2022-02-22', '24', 2, 'ESPAñOL', 'E2', 'E2', 'EE', 'EE', '020202', '0202', '02', '222222222', 'EDASD', 'TRABAJADOR DEPENDIENTE', 'PRIMARIA', 'SOLTERO', 'PERUANA', 'CDADS', '', 0, NULL, '2023-07-28 18:23:56', '64c44de812c08.jpg');
...
CREATE TABLE `asistencias` (
  ...
  `fecha` date NOT NULL,
  `presente` int NOT NULL COMMENT '1=presente; 0=falta',
...
INSERT INTO `asistencias` (`id`, `idAlumno`, `fecha`, `presente`, `registro`) VALUES
(1, 33, '2023-07-30', 1, '2023-07-30 18:26:12'),
(2, 36, '2023-07-30', 1, '2023-07-30 18:28:12'),
(3, 36, '2023-07-30', 1, '2023-07-30 18:28:20'),
(4, 33, '2023-07-30', 1, '2023-07-30 18:28:56'),
(5, 32, '2023-07-30', 1, '2023-07-30 18:28:56'),
(6, 31, '2023-07-30', 1, '2023-07-30 18:28:56'),
(7, 12, '2023-07-30', 1, '2023-07-30 18:28:56'),
(8, 13, '2023-07-30', 1, '2023-07-30 18:28:56'),
(9, 15, '2023-07-30', 1, '2023-07-30 18:28:56'),
(10, 34, '2023-07-30', 1, '2023-07-30 18:28:56'),
(11, 36, '2023-07-30', 1, '2023-07-30 18:28:56'),
(12, 33, '2023-07-31', 1, '2023-07-30 18:29:27'),
(13, 32, '2023-07-31', 1, '2023-07-30 18:29:27'),
(14, 31, '2023-07-31', 1, '2023-07-30 18:29:27'),
(15, 12, '2023-07-31', 1, '2023-07-30 18:29:27'),
(16, 13, '2023-07-31', 1, '2023-07-30 18:29:27'),
(17, 15, '2023-07-31', 1, '2023-07-30 18:29:27'),
(18, 34, '2023-07-31', 1, '2023-07-30 18:29:27'),
(19, 36, '2023-07-31', 1, '2023-07-30 18:29:27'),
(20, 33, '2023-08-01', 0, '2023-07-30 18:29:49'),
(21, 32, '2023-08-01', 0, '2023-07-30 18:29:49'),
(22, 31, '2023-08-01', 0, '2023-07-30 18:29:49'),
(23, 12, '2023-08-01', 0, '2023-07-30 18:29:49'),
(24, 13, '2023-08-01', 0, '2023-07-30 18:29:49'),
(25, 15, '2023-08-01', 0, '2023-07-30 18:29:49'),
(26, 34, '2023-08-01', 0, '2023-07-30 18:29:49'),
(27, 36, '2023-08-01', 0, '2023-07-30 18:29:49');
...
INSERT INTO `configuraciones` (`id`, `campo`, `valor`) VALUES
(1, 'cantidadNotas', '4');
...
INSERT INTO `notas` (`id`, `idAlumno`, `nota`, `registro`) VALUES
(40, 13, 16, '2023-07-30 16:37:49'),
(41, 13, 14, '2023-07-30 16:37:49'),
(42, 13, 14, '2023-07-30 16:37:49'),
(43, 13, 10, '2023-07-30 16:37:49'),
(48, 12, 11, '2023-07-30 16:53:46'),
(49, 12, 15, '2023-07-30 16:53:46'),
(50, 12, 16, '2023-07-30 16:53:46'),
(51, 12, 18, '2023-07-30 16:53:46'),
(52, 14, 5, '2023-07-30 18:08:03'),
(53, 14, 14, '2023-07-30 18:08:03'),
(54, 14, 11, '2023-07-30 18:08:03'),
(55, 14, 19, '2023-07-30 18:08:03'),
(56, 15, 11, '2023-07-30 18:15:26'),
(57, 15, 12, '2023-07-30 18:15:26'),
(58, 15, 13, '2023-07-30 18:15:26'),
(59, 15, 14, '2023-07-30 18:15:26'),
(60, 31, 14, '2023-07-30 18:16:05'),
(61, 31, 14, '2023-07-30 18:16:05'),
(62, 31, 15, '2023-07-30 18:16:05'),
(63, 31, 16, '2023-07-30 18:16:05');
...
CREATE TABLE `ocupaciones` (
  `id` int NOT NULL,
  `opcionOcupacional` text CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
...
(6, 'INDUSTRIAS ALIMENTARIAS', '2023-07-25 18:18:49'),
(7, 'MECANICA AUTOMOTRIZ', '2023-07-25 18:18:56'),
(8, 'NINGUNO', '2023-07-25 18:23:13');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `udepartamentos`
--

CREATE TABLE `udepartamentos` (
  `id` varchar(2) NOT NULL,
  `name` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

--
-- Volcado de datos para la tabla `udepartamentos`
--

INSERT INTO `udepartamentos` (`id`, `name`) VALUES
('01', 'Amazonas'),
('02', 'Áncash'),
('03', 'Apurímac'),
('04', 'Arequipa'),
...
--
-- Estructura de tabla para la tabla `udistritos`
--

CREATE TABLE `udistritos` (
...
--
-- Volcado de datos para la tabla `udistritos`
--

INSERT INTO `udistritos` (`id`, `name`, `province_id`, `department_id`) VALUES
...
--
-- Estructura de tabla para la tabla `uprovincias`
--

CREATE TABLE `uprovincias` (
...
--
-- Volcado de datos para la tabla `uprovincias`
--

INSERT INTO `uprovincias` (`id`, `name`, `department_id`) VALUES
('0101', 'Chachapoyas', '01'),
('0102', 'Bagua', '01'),
('0103', 'Bongará', '01'),
...
INSERT INTO `usuarios` (`id`, `nombre`, `usuario`, `password`, `idOcupacion`, `perfil`, `foto`, `estado`, `ultimo_login`, `fecha`) VALUES
(1, 'Administrador', 'admin', '$2a$07$asxx54ahjppf45sd87a5auXBm1Vr2M1NV5t/zNQtGHGpS5fFirrbG', 1, 'Administrador', '', 1, '2023-07-30 18:16:34', '2023-07-30 23:16:34'),
(8, 'Silvia Espejo Leon', 'silviaDRTPE', '$2a$07$asxx54ahjppf45sd87a5auGZEtGHuyZwm.Ur.FJvWLCql3nmsMbXy', 1, 'Secretario', 'vistas/img/usuarios/silviaDRTPE/929.jpg', 1, '2023-07-17 21:22:05', '2023-07-18 02:22:05'),
(15, 'Cesar Robles Capcha', 'SCMCESAR', '$2a$07$asxx54ahjppf45sd87a5auGZEtGHuyZwm.Ur.FJvWLCql3nmsMbXy', 1, 'Docente', '', 1, NULL, '2023-05-26 17:06:38'),
(16, 'Leopoldo Dante Mendez Aguirre', 'CILEOPOLDO', '$2a$07$asxx54ahjppf45sd87a5auGZEtGHuyZwm.Ur.FJvWLCql3nmsMbXy', 2, 'Docente', '', 1, '2023-07-30 18:18:32', '2023-07-30 23:18:32'),
(17, 'Paul Javier Albino Mendez', 'CEPAUL', '$2a$07$asxx54ahjppf45sd87a5auGZEtGHuyZwm.Ur.FJvWLCql3nmsMbXy', 3, 'Docente', '', 1, NULL, '2023-07-26 01:03:01'),
(18, 'Jesus Roberto Raymundo Cardenas', 'EIJESUS', '$2a$07$asxx54ahjppf45sd87a5auGZEtGHuyZwm.Ur.FJvWLCql3nmsMbXy', 4, 'Docente', '', 1, '2023-07-17 22:15:33', '2023-07-26 01:03:12'),
(19, 'Doris Teresa Gaspar Tovar', 'IADORIS', '$2a$07$asxx54ahjppf45sd87a5auGZEtGHuyZwm.Ur.FJvWLCql3nmsMbXy', 5, 'Docente', '', 1, NULL, '2023-07-26 01:03:17'),
(20, 'Cesar Robles Capcha', 'MACESAR', '$2a$07$asxx54ahjppf45sd87a5auGZEtGHuyZwm.Ur.FJvWLCql3nmsMbXy', 6, 'Docente', '', 1, '2023-06-23 11:05:03', '2023-07-26 01:03:23');
...
ALTER TABLE `alumnos`
  ...
  ADD KEY `fk_nacionalidad` (`idNacionalidad`),
  ADD KEY `fk_departamento` (`departamento`),
  ADD KEY `fk_provincia` (`provincia`),
  ADD KEY `fk_distrito` (`distrito`),
  ADD KEY `fk_ocupacion` (`idOcupacion`);
...
ALTER TABLE `asistencias`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_asistencias` (`idAlumno`);
...
--
-- Indices de la tabla `udepartamentos`
--
ALTER TABLE `udepartamentos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `udistritos`
--
ALTER TABLE `udistritos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `uprovincias`
--
ALTER TABLE `uprovincias`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `alumnos`
  ADD CONSTRAINT `fk_departamento` FOREIGN KEY (`departamento`) REFERENCES `udepartamentos` (`id`),
  ADD CONSTRAINT `fk_distrito` FOREIGN KEY (`distrito`) REFERENCES `udistritos` (`id`),
  ADD CONSTRAINT `fk_nacionalidad` FOREIGN KEY (`idNacionalidad`) REFERENCES `nacionalidad` (`id`),
  ADD CONSTRAINT `fk_ocupacion` FOREIGN KEY (`idOcupacion`) REFERENCES `ocupaciones` (`id`),
  ADD CONSTRAINT `fk_provincia` FOREIGN KEY (`provincia`) REFERENCES `uprovincias` (`id`);

--
-- Filtros para la tabla `asistencias`
--
ALTER TABLE `asistencias`
  ADD CONSTRAINT `FK_asistencias` FOREIGN KEY (`idAlumno`) REFERENCES `alumnos` (`id`);

--
-- Filtros para la tabla `notas`
--
ALTER TABLE `notas`
  ADD CONSTRAINT `FK_alumno` FOREIGN KEY (`idAlumno`) REFERENCES `alumnos` (`id`);
COMMIT;
